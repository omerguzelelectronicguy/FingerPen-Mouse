...
void loop()
{
  ...
  { // Get the Latest packet // 2 to 3 ms is passed here. But the problem is that is not available always.
    ...
    float angle_a = -euler[0], angle_b = euler[1], angle_c = -euler[2];
#define angle_correction 1
    ...
    float angle_a = -ypr[0], angle_b = ypr[1], angle_c = ypr[2];
#define angle_correction 1
    ...
    float angle_a = q.z, angle_b = q.y, angle_c = q.x;
#define angle_correction 3.14159
#endif
...
#define angle_correction 3.14159
#endif
#define sensitivity 750* angle_correction // angle correction is to equalize each angle
    int dx = (int) (sensitivity * (xpos - angle_a));
    int dy = (int) (sensitivity * (ypos - angle_b));
    int dz = (int) (sensitivity * (zpos - angle_c));
